...
You are encouraged to compare the implementation of both the standard ImpactJS particle implementation and the optimized one; in particular, [particle.js](particle.js) vs. [particle-fast.js](particle-fast.js) and [main.js](main.js) vs. [main-fast.js](main-fast.js). Both the *-fast.js files are heavily commented to highlight their differences.
